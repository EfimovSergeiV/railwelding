          ...
          <div class="absolute w-full h-full">
            ...
            <div class="flex items-center justify-center h-full">
              <div class="grid grid-cols-1 gap-4">
                <p class="text-3xl text-white font-bold uppercase">Ищете надежное и эффективное решение для сварки рельсов?</p>
                <p class="text-2xl text-white font-bold uppercase">У нас есть идеальное предложение для вас!</p>                
              </div>
            </div>
